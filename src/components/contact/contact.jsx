...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_cwvrlcj', 'template_mx7tdia', form.current, {
          publicKey: 'UKqRX9R8emboc_Q7s',
        })
        e.target.reset()
    }
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">prathmesh.pardeshi1709@gmail.com</span>
                        
                        <a href="mailto:prathmesh.pardeshi1709@gmail.com" className="contact__button">
                            Write Me{" "} 
